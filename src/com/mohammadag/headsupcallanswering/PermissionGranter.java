...
public class PermissionGranter {
	...
	private static final String PERM_MODIFY_PHONE_STATE = "android.permission.MODIFY_PHONE_STATE";
		...
		try {
			...
			XposedHelpers.findAndHookMethod(pmServiceClass, "grantPermissionsLPw",
				...
				protected void afterHookedMethod(MethodHookParam param) throws Throwable {
					...
					// Us
					if (pkgName.equals("com.mohammadag.headsupcallanswering")) {
						...
						// Add android.permission.MODIFY_PHONE_STATE needed to answer/end calls
						if (!grantedPerms.contains(PERM_MODIFY_PHONE_STATE)) {
							final Object pCamera = XposedHelpers.callMethod(permissions, "get",
									PERM_MODIFY_PHONE_STATE);
							grantedPerms.add(PERM_MODIFY_PHONE_STATE);
